...
bool USGameplayFunctionLibrary::ApplyDamage(AActor* DmageCauser, AActor* TargetActor, float DamageAmount)
{
	USAttributeComponent* AttributeComp = USAttributeComponent::GetAttributes(TargetActor);
	if (AttributeComp)
	{
		return AttributeComp->ApplyHealthChange(DmageCauser, -DamageAmount);
	}
	return false;
}
